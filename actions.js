...
Нажмите кнопку ниже, чтобы перейти в магазин приложений.`;
  ...
  bot.action(/^setup_downloaded_(ios|android|android_tv|windows|macos)_(\d+)$/, async (ctx) => {
    ...
    const fullMessage =
      ...
      "Доступны два типа подписки — можно добавить обе. Все ваши подписки и ссылки в разделе «Мои подписки» в меню. Там можно вручную скопировать ссылку и добавить её в Happ.";
